...
const ReportedUsers = () => {
  ...
  const { handleAlert, navigate } = useContext(mainContext);
  ...
  const fetchReportedUsers = () => {
    fetch(`${API_URL}/api/report/`, {
      ...
      .then((data) => setData(data?.reportedUsers));
  };
  ...
  const handleBlock = (id) => {
    fetch(`${API_URL}/api/mechanic/block/${id}`, {
      method: "POST",
      headers: {
  ...
  const handleUnblock = (id) => {
    fetch(`${API_URL}/api/mechanic/unblock/${id}`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
          <TableHead>
            <TableRow>
              ...
              <TableCell sx={{ fontWeight: "700", maxWidth: "200px" }}>
                Report Description
              </TableCell>
          ...
          <TableBody>
            {data?.map((row) => (
              ...
              >
                ...
                <TableCell>{row.mechanicId.phone}</TableCell>
                ...
                <TableCell>
                  ...
                  >
                    <Button
                      ...
                      onClick={() =>
                        navigate("/mechanic/" + row?.mechanicId.slug)
                      }
                    >
                      View
                    </Button>
                    {!row?.mechanicId.isBlocked ? (
                      <Button
                        sx={{
                        ...
                        onClick={() => handleBlock(row.mechanicId._id)}
                      >
                        Block
                      </Button>
                    ) : (
                      <Button
                        ...
                        onClick={() => handleUnblock(row.mechanicId._id)}
                      >
                        Unblock
                      </Button>
                    )}
