...
const ManageMechanicPage = () => {
  ...
  return (
    <div className="admin-container">
      <div className="title">Manage Mechanic</div>
                ...
                <TableCell>
                  ...
                  >
                    <Button
                      ...
                      onClick={() => navigate("/mechanic/" + row?.slug)}
                    >
                      View
                    </Button>
                    {!row?.isBlocked ? (
...
export default ManageMechanicPage;
